                        ...
                        <Grid item>
                            <Grid container alignItems="center" spacing={1}>
                                ...
                                <Grid item sm zeroMinWidth>
                                    <Typography variant="h4"> 19.63%</Typography>
                                </Grid>
                            </Grid>
                        </Grid>
                        <Grid item>
                            <Grid container alignItems="center" spacing={1}>
                                ...
                                <Grid item sm zeroMinWidth>
                                    <Typography variant="h4"> 20.43%</Typography>
                                </Grid>
                            </Grid>
                        </Grid>
                        <Grid item>
                            <Grid container alignItems="center" spacing={1}>
                                ...
                                <Grid item sm zeroMinWidth>
                                    <Typography variant="h4"> 39.11%</Typography>
                                </Grid>
                            </Grid>
                        </Grid>
                        <Grid item>
                            <Grid container alignItems="center" spacing={1}>
                                ...
                                <Grid item sm zeroMinWidth>
                                    <Typography variant="h4"> 15.06%</Typography>
                                </Grid>
                            </Grid>
                        </Grid>                        
                        <Grid item xs zeroMinWidth />
