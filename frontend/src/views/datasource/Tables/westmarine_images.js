        ...
        <FormControl sx={{ m: 1, minWidth: 150 }}>
            ...
            <Select
                ...
                onChange={async (e) => {
                    ...
                    fetchProductImages('westmarine',e.target.value);
                }}
                label="Project"
            >            
...
const Tables = () => {
    ...
    useEffect(() => {
        // setLoading(false);
        fetchProductImages('westmarine',project);                                  
    }, []);        
    ...
    const fields = [
        ...
        },
        {
          ...
          },
          {
            ...
            example: "https://kmou-dp.s3.ap-southeast-1.westmarineaws.com/Marine-Parts/westmarine/Hull/0b929c64a3bce60d11208aa693b59e1d3ff3dc48.jpg",
            validations: [
              {
                rule: "required",
    ...
    const onSubmit = (data, file) => {
        insertProductImages(data,'westmarine',project)
    }
