        ...
        <FormControl sx={{ m: 1, minWidth: 150 }}>
            ...
            <Select
                ...
                onChange={async (e) => {
                    ...
                    fetchProductImages('svb24',e.target.value);
                }}
                label="Project"
            >            
...
const Tables = () => {
    ...
    useEffect(() => {
        // setLoading(false);
        fetchProductImages('svb24',project);                                  
    }, []);        
    ...
    const fields = [
        ...
        },
        {
          ...
          },
          {
            ...
            example: "https://kmou-dp.s3.ap-southeast-1.amazonaws.com/Marine-Parts/svb24/Hull/0b929c64a3bce60d11208aa693b59e1d3ff3dc48.jpg",
            validations: [
              {
                rule: "required",
    ...
    const onSubmit = (data, file) => {
        insertProductImages(data,'svb24',project)
    }
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell component="th" scope="row" padding="normal">
                                                <img style={{width: 100}} src={row.image_path}/>
                                            </TableCell>
                                            {/* <TableCell component="th" scope="row" padding="normal">
                                                {row.image_url}
                                            </TableCell> */}
